...
import { FiExternalLink, FiFileText, FiHelpCircle, FiImage, FiMessageCircle, FiSend, FiX } from "react-icons/fi";
                                ...
                                <div className="grid gap-4">
                                    ...
                                    {selectedEntry.entryType === "Product" ? (
                                        <>
                                            ...
                                            <input className="h-11 rounded-lg border border-white/10 bg-black/20 px-3 text-sm font-semibold text-white outline-none transition placeholder:text-white/30 focus:border-[#842cff] focus:ring-2 focus:ring-[#842cff]/20" value={suggestionForm.price} onChange={(event) => setSuggestionForm((form) => ({ ...form, price: event.target.value }))} placeholder="Suggested price" />
                                        </>
                                    ) : (
                                        <>
